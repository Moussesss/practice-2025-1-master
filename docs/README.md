...
Выбор тематики. Мной была выбрана тема – «Создание простого текстового редактора на Python с использованием Tkinter». Таким образом, сформулируем цели и задачи проекта:
